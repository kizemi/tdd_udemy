  ...
  group("text", () {
    testWidgets("数字", (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        MaterialApp(home: KeyPad( (_){} ), // ✅ ダミーのコールバックを渡す
        ),
      );
    ...
    testWidgets("文字", (WidgetTester tester) async {
      ...
      expect(find.text("+"), findsNothing); // +や=は文字ではなくてアイコンで実装されているので文字が見つからないのが正常
    ...
    group("キータップ", (){
      testWidgets("数字", (WidgetTester tester) async {
        ...
        /// 仮のウィジェットを作成する
        await tester.pumpWidget(
          MaterialApp(home: KeyPad(onPress),
          ),
        );
      ...
      testWidgets("文字", (WidgetTester tester) async {
        ...
        /// 仮のウィジェットを作成する
        await tester.pumpWidget(
          MaterialApp(home: KeyPad(onPress), // ✅ ダミーのコールバックを渡す
          ),
        );
